...
public class RNFaceDetector {
  ...
  public static int ALL_CONTOURS = 1;
  public static int NO_CONTOURS = 0;
  ...
  public void setContourType(int contourType) {
    if (contourType != mLandmarkType) {
      release();
//      mBuilder.setLandmarkType(contourType);
      mLandmarkType = contourType;
    }
  }
